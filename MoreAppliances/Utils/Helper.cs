        ...
        internal static void SetupTable(GameObject prefab)
        {
            ...
            ReflectionUtils.GetField<AttachmentView>("EffectLookups").SetValue(attachmentView, new List<AttachmentView.EffectLookup>()
            {
                new AttachmentView.EffectLookup()
                {
                    ...
                    Effect = (Effect)GetExistingGDO(EffectReferences.Breadsticks),
                ...
                new AttachmentView.EffectLookup()
                {
                    ...
                    Effect = (Effect)GetExistingGDO(EffectReferences.Candles),
                ...
                new AttachmentView.EffectLookup()
                {
                    ...
                    Effect = (Effect)GetExistingGDO(EffectReferences.Napkins),
                ...
                new AttachmentView.EffectLookup()
                {
                    ...
                    Effect = (Effect)GetExistingGDO(EffectReferences.SharpCutlery)
                }
            });
